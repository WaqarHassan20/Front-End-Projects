...
function FeaturesImgs({ url1, url2, text1, text2, heading1, heading2 }) {
  return (
    <div className="cards w-full flex gap-[1.1vw] my-[10vw] mt-14">
      <div className="card-container w-[48vw] h-[68vh] relative">
        <h1 className="absolute left-full flex overflow-hidden top-1/2 -translate-x-1/2 z-50 text-[#CDEA68] -translate-y-1/2 font-bold text-[5.3vw] tracking-tighter leading-none">
          {typeof text1 === "string" &&
      ...
      <div className="card-container w-[48vw] h-[68vh] relative">
        <h1 className="absolute flex overflow-hidden right-full top-1/2 translate-x-1/2 text-[#CDEA68] -translate-y-1/2 font-bold text-[5.3vw] tracking-tighter leading-none">
          {typeof text2 === "string" &&
